!function (e) {
    ...
    , function (e, t, n) {
        ...
        !function (t, n) {
            ...
            function S(e, t, n, i) {
                ...
                if (v || d > 1 && "string" == typeof f && !ae.checkClone && Ke.test(f))
            ...
            function $(e, t, n) {
                var i, r, o = 0, s = $.prefilters.length, a = le.Deferred().always(function () {
                    ...
                    if (r)
                        return !1;
                    for (var t = ct || M(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, s = 0, c = l.tweens.length; c > s; s++)
                        l.tweens[s].run(o);
	 ...
	 */
                function (e) {
                    function t(e, t, n, i) {
                        ...
                        if (n = n || [],
                            ...
                            return n;
                        if (!i && ((t ? t.ownerDocument || t : F) !== D && R(t),
                            t = t || D,
                            j)) {
                            if (11 !== v && (l = me.exec(e)))
                                if (r = l[1]) {
                    ...
                    var b, k, w, P, T, C, S, A, _, N, E, R, D, L, j, q, I, H, M, O = "sizzle" + 1 * new Date, F = e.document, B = 0, W = 0, $ = n(), U = n(), z = n(), X = function (e, t) {
                        return e === t && (E = !0),
                            0
                    }, K = 1 << 31, Y = {}.hasOwnProperty, V = [], G = V.pop, J = V.push, Q = V.push, Z = V.slice, ee = function (e, t) {
                        for (var n = 0, i = e.length; i > n; n++)
                            if (e[n] === t)
                                return n;
                        return -1
                    ...
                    k = t.support = {},
                        ...
                        R = t.setDocument = function (e) {
                            ...
                            return i !== D && 9 === i.nodeType && i.documentElement ? (D = i,
                                ...
                                k.getElementsByClassName = ge.test(D.getElementsByClassName),
                                ...
                                I = [],
                                q = [],
                                (k.qsa = ge.test(D.querySelectorAll)) && (r(function (e) {
                                ...
                                X = t ? function (e, t) {
                                    ...
                                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                        1 & n || !k.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === F && M(F, e) ? -1 : t === D || t.ownerDocument === F && M(F, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
                                }
                                    : function (e, t) {
                                        if (e === t)
                                            return E = !0,
                                        ...
                                        if (!r || !o)
                                            return e === D ? -1 : t === D ? 1 : r ? -1 : o ? 1 : N ? ee(N, e) - ee(N, t) : 0;
                                        if (r === o)
                                            return s(e, t);
                        ...
                        t.matchesSelector = function (e, n) {
                            if ((e.ownerDocument || e) !== D && R(e),
                                n = n.replace(ue, "='$1']"),
                                k.matchesSelector && j && !z[n + " "] && (!I || !I.test(n)) && (!q || !q.test(n)))
                                try {
                                    var i = H.call(e, n);
                        ...
                        t.contains = function (e, t) {
                            return (e.ownerDocument || e) !== D && R(e),
                                M(e, t)
                        }
                        ,
                        t.attr = function (e, t) {
                    ...
                    return d.prototype = w.filters = w.pseudos,
                        ...
                        A = t.select = function (e, t, n, i) {
                            var r, o, s, a, c, l = "function" == typeof e && e, d = !i && C(e = l.selector || e);
                            if (n = n || [],
                                1 === d.length) {
                ...
                le.each({
                    ...
                    le.fn[e] = function (n, i) {
                        ...
                        return "Until" !== e.slice(-5) && (i = n),
                            ...
                            this.length > 1 && (Te[e] || le.uniqueSort(r),
                                Pe.test(e) && r.reverse()),
                            this.pushStack(r)
                    }
                });
                ...
                le.fn.extend({
                    data: function (e, t) {
                        ...
                        return "object" == typeof e ? this.each(function () {
                            ...
                            var n, i;
                            if (o && void 0 === t) {
                                if (n = Ee.get(o, e) || Ee.get(o, e.replace(De, "-$&").toLowerCase()),
                                    void 0 !== n)
                                    return n;
                                if (i = le.camelCase(e),
                                    n = Ee.get(o, i),
            ...
            var Ge, Je = {
                HTML: "block",
                BODY: "block"
            }, Qe = /^margin/, Ze = new RegExp("^(" + Le + ")(?!px)[a-z%]+$", "i"), et = function (e) {
            ...
            le.extend({
                ...
                style: function (e, t, n, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        ...
                        return t = le.cssProps[a] || (le.cssProps[a] = D(a) || a),
            ...
            le.fn.extend({
                ...
                hasClass: function (e) {
                    var t, n, i = 0;
                    for (t = " " + e + " "; n = this[i++];)
                        if (1 === n.nodeType && (" " + U(n) + " ").replace(gt, " ").indexOf(t) > -1)
                            return !0;
                    return !1
                }
            });
                ...
                le.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        if (v.promise(w).complete = g.add,
                            ...
                            p.dataTypes = le.trim(p.dataType || "*").toLowerCase().match(Ce) || [""],
                            null == p.crossDomain) {
                            l = Z.createElement("a");
                            try {
                                l.href = p.url,
                        ...
                        u = le.event && p.global,
                            ...
                            p.hasContent || (p.data && (o = p.url += (wt.test(o) ? "&" : "?") + p.data,
                                delete p.data),
                                p.cache === !1 && (p.url = Tt.test(o) ? o.replace(Tt, "$1_=" + kt++) : o + (wt.test(o) ? "&" : "?") + "_=" + kt++)),
                            ...
                            t = function (e) {
                                return function () {
                                    t && (t = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null,
                                        "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Mt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                            binary: a.response
                                        } : {
                                                text: a.responseText
        ...
        (function (t) {
            ...
            d.prototype = {
                ...
                packetReceived: function (e, t) {
                    ...
                    if (o > i)
                        return t.sendOnePacket(e.cellWhere.id, e.cell.id, "receive", "ack", e.isSelected),
                            t.voice.speak(this.getResultMessage(r.packet_received_out_of_order.voice, [n.id, n.id, r.at_the_receiver_side])),
                            void t.addLog(this.getResultMessage(r.packet_received_out_of_order.text, [r.R, n.id, n.id, t.receivePackets.lastPacketId]));
                    if (i >= o && o + s > i) {
                        if (i == a + 1) {
                            t.voice.speak(this.getResultMessage(r.packet_received.voice, [n.id, n.id, n.id, r.at_the_receiver_side])),
                                t.addLog(this.getResultMessage(r.packet_received.text, [r.R, n.id, n.id, n.id])),
                                ...
                                o < t.countCells - s && (t.receivePackets.currentPositionInArray++,
                                    o++);
                            for (var c = i + 1; c < t.allCells.receive.length; c++) {
                                var n = t.allCells.receive[c];
                                "buffered" == n.status ? (n.setStatus("received"),
                                    t.voice.speak(this.getResultMessage(r.buffered_delivered.voice, [n.id, r.at_the_receiver_side])),
                                    t.addLog(this.getResultMessage(r.buffered_delivered.text, [r.R, n.id])),
                                    t.receivePackets.lastPacketId = n.id,
                                    o < t.countCells - s && (t.receivePackets.currentPositionInArray++,
                        ...
                        return i >= a && (e.cellWhere.setStatus("buffered"),
                            t.voice.speak(this.getResultMessage(r.packet_buffered.voice, [n.id, n.id, r.at_the_receiver_side])),
                            t.addLog(this.getResultMessage(r.packet_buffered.text, [r.R, n.id, n.id]))),
                            void t.sendOnePacket(e.cellWhere.id, e.cell.id, "receive", "ack", e.isSelected)
                    }
                ...
                ackPacketReceived: function (e, t) {
                    ...
                    if (o > i && e.cellWhere.setStatus("ackReceived"),
                        i >= o && o + s > i) {
                        if (i == a + 1) {
                            e.cellWhere.setStatus("ackReceived"),
                                t.voice.speak(this.getResultMessage(r.cumulative_ack_received.voice, [e.cell.id, e.cell.id, r.at_the_sender_side])),
                                t.addLog(this.getResultMessage(r.cumulative_ack_received.text, [r.S, e.cell.id, e.cell.id])),
                                t.senderPackets.lastPacketId = n.id,
                                o < t.countCells - s && (t.senderPackets.currentPositionInArray++,
                                    t.senderPackets.currentCountSenderPackets--);
                            for (var c = i + 1; c < t.allCells.sender.length; c++) {
                                var n = t.allCells.sender[c];
                                "ackReceived" == n.status ? (t.senderPackets.lastPacketId = n.id,
                                    o < t.countCells - s - 1 && (t.senderPackets.currentPositionInArray++,
                                        t.senderPackets.currentCountSenderPackets--,
                                        t.senderPackets.lastPacketId = n.id,
                                        o++)) : c = t.allCells.receive.length
                            }
                        ...
                        return t.allCells.sender.forEach(function (e) {
                            ...
                            l && (t.voice.speak(this.getResultMessage(r.start_timer_for_packet.voice, [n.id, r.at_the_sender_side])),
                                t.addLog(this.getResultMessage(r.start_timer_for_packet.text, [r.S, n.id]))),
                            0 == l && t.stopTimer(),
                            this.updateElements(),
                ...
                waitTimer: function () {
                    ...
                    this.allCells.sender.forEach(function (a) {
                        ...
                        "waiting" == c && (n++,
                            ...
                            s = a.id,
                            t && (t = !1,
                                i.voice.speak(i.getResultMessage(r.timeout_occured.voice, [a.id, a.id, r.at_the_sender_side])),
                                i.addLog(i.getResultMessage(r.timeout_occured.text, [r.S, a.id, a.id]))))
                    }),
                        l = 0
                },
                pause: function () {
    ...
    <div id="content" class="content">
        <h1>选择重传协议</h1>
        <p>
            这个交互式动画使选择重传协议变得生动起来。
            在这个演示中，发送窗口将发送方限制为最多5个未完成、未解包的数据包。
            要创建新数据包，请单击“发送新的”。
            此操作将开始在发送方和接收方之间移动数据包。
            要模拟丢失，请选择一个正在移动数据包或ACK，然后按“杀死包/ACK”。
            使用“暂停”和“恢复”使选择更容易。
        ...
        <div class="applet">
            <div class="buttons" id="buttons-navigation">
                ...
                <button class="killpacket-ack">杀死包/ACK</button>
            ...
            <div class="animation">
                ...
                <div class="top-label">
                    ...
                    <p class="blue bottom-label" style="margin-top:200px;">接收方（发送窗口大小 = 5）</p>
                </div>
            </div>
            <div class="footer">
                <div class="legend">
                ...
                <div class="log-container" tabindex="-1">
                    <p>(S) - 发送方的操作</p>
                    <p>(R) - 接收方的操作</p>
                    <textarea tabindex="-1" id="log-textarea" rows="12" readonly></textarea>
                </div>
            </div>
        </div>
    </div>`
