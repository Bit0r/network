!function (e) {
        ...
        !function (t, n) {
            ...
            function f(e, t, n, i) {
                var r, o = 1, s = 20, a = i ? function () {
                    ...
                    , c = a(), l = n && n[3] || (le.cssNumber[t] ? "" : "px"), u = (le.cssNumber[t] || "px" !== l && +c) && je.exec(le.css(e, t));
                if (u && u[3] !== l) {
                    l = l || u[3],
                        n = n || [],
                        u = +c || 1;
            ...
            function S(e, t, n, i) {
                t = te.apply([], t);
                var r, o, s, a, c, l, u = 0, d = e.length, p = d - 1, f = t[0], v = le.isFunction(f);
                if (v || d > 1 && "string" == typeof f && !ae.checkClone && Ye.test(f))
                    return e.each(function (r) {
                        var o = e.eq(r);
                        v && (t[0] = f.call(this, r, o.html())),
                            S(o, t, n, i)
                    });
                if (d && (r = g(t, e[0].ownerDocument, !1, e, i),
                    ...
                    o || i)) {
                    for (s = le.map(h(r, "script"), w),
                        a = s.length; d > u; u++)
                        c = r,
                            u !== p && (c = le.clone(c, !0, !0),
                                a && le.merge(s, h(c, "script"))),
                            n.call(e[u], c, u);
                    if (a)
                        for (l = s[s.length - 1].ownerDocument,
                            ...
                            u = 0; a > u; u++)
                            c = s[u],
                                Oe.test(c.type || "") && !Ne.access(c, "globalEval") && le.contains(l, c) && (c.src ? le._evalUrl && le._evalUrl(c.src) : le.globalEval(c.textContent.replace(Ve, "")))
                }
                return e
            }
            function A(e, t, n) {
            ...
            function N(e) {
                var t = Z
                    , n = Je[e];
                return n || (n = _(e, t),
                    "none" !== n && n || (Ke = (Ke || le("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
            ...
            function E(e, t, n) {
                ...
                return n = n || et(e),
                    ...
                    n && !ae.pixelMarginRight() && Ze.test(s) && Qe.test(t) && (i = a.width,
                        r = a.minWidth,
                        o = a.maxWidth,
            ...
            function I(e, t) {
                for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
                    i = e[s],
                        i.style && (o[s] = Ne.get(i, "olddisplay"),
                            n = i.style.display,
                            t ? (o[s] || "none" !== n || (i.style.display = ""),
                                "" === i.style.display && Ie(i) && (o[s] = Ne.access(i, "olddisplay", N(i.nodeName)))) : (r = Ie(i),
                                    "none" === n && r || Ne.set(i, "olddisplay", r ? n : le.css(i, "display"))));
                for (s = 0; a > s; s++)
                    i = e[s],
            ...
            function B(e, t, n) {
                var i, r, o, s, a, c, l, u, d = this, p = {}, f = e.style, h = e.nodeType && Ie(e), v = Ne.get(e, "fxshow");
                n.queue || (a = le._queueHooks(e, "fx"),
                    ...
                    1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY],
                        ...
                        "inline" === u && "none" === le.css(e, "float") && (f.display = "inline-block")),
            ...
            function $(e, t, n) {
                var i, r, o = 0, s = $.prefilters.length, a = le.Deferred().always(function () {
                    ...
                    if (r)
                        return !1;
                    for (var t = ct || H(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, s = 0, c = l.tweens.length; c > s; s++)
                        l.tweens[s].run(o);
                    return a.notifyWith(e, [l, o, n]),
                        1 > o && c ? n : (a.resolveWith(e, [l]),
                            !1)
                }, l = a.promise({
                    elem: e,
                    props: le.extend({}, t),
	 ...
	 */
                function (e) {
                    function t(e, t, n, i) {
                        var r, o, s, a, c, l, d, f, h = t && t.ownerDocument, v = t ? t.nodeType : 9;
                        if (n = n || [],
                            "string" != typeof e || !e || 1 !== v && 9 !== v && 11 !== v)
                            return n;
                        if (!i && ((t ? t.ownerDocument || t : F) !== L && R(t),
                            t = t || L,
                            j)) {
                            if (11 !== v && (l = me.exec(e)))
                                if (r = l[1]) {
                                    ...
                                    if (l[2])
                                        return Q.apply(n, t.getElementsByTagName(e)),
                                            n;
                                    if ((r = l[3]) && k.getElementsByClassName && t.getElementsByClassName)
                            ...
                            if (k.qsa && !U[e + " "] && (!q || !q.test(e))) {
                                if (1 !== v)
                                    ...
                                    for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = O),
                                        d = T(e),
                                        o = d.length,
                    ...
                    function m(e, t, n, r, o, s) {
                        return r && !r[O] && (r = m(r)),
                            o && !o[O] && (o = m(o, s)),
                            i(function (i, s, a, c) {
                                var l, u, d, p = [], f = [], h = s.length, m = i || v(t || "*", a.nodeType ? [a] : a, []), y = !e || !i && t ? m : g(m, p, e, a, c), x = n ? o || (i ? e : h || r) ? [] : s : y;
                                if (n && n(y, x, a, c),
                                    r)
                                    for (l = g(x, f),
                                        r(l, [], a, c),
                                ...
                                if (i) {
                                    if (o || e) {
                                        ...
                                        for (u = x.length; u--;)
                                            (d = x[u]) && (l = o ? ee(i, d) : p[u]) > -1 && (i[l] = !(s[l] = d))
                                    }
                                } else
                                    x = g(x === s ? x.splice(h, x.length) : x),
                                        o ? o(null, s, x, c) : Q.apply(s, x)
                            })
                    }
                    function y(e) {
                    ...
                    function x(e, n) {
                        var r = n.length > 0
                            ...
                            , s = function (i, s, a, c, l) {
                                var u, d, p, f = 0, h = "0", v = i && [], m = [], y = _, x = i || o && w.find.TAG("*", l), b = B += null == y ? 1 : Math.random() || .1, k = x.length;
                                for (l && (_ = s === L || s || l); h !== k && null != (u = x[h]); h++) {
                                    if (o && u) {
                                        for (d = 0,
                                            s || u.ownerDocument === L || (R(u),
                                                a = !j); p = e[d++];)
                                            if (p(u, s || L, a)) {
                                                c.push(u);
                                                break
                                ...
                                if (f += h,
                                    ...
                                    if (i) {
                                        if (f > 0)
                                            for (; h--;)
                                                v[h] || m[h] || (m[h] = K.call(c));
                                        m = g(m)
                                    }
                                    Q.apply(c, m),
                                        l && !i && m.length > 0 && f + n.length > 1 && t.uniqueSort(c)
                                }
                                return l && (B = b,
                                    _ = y),
                                    v
                    ...
                    var b, k, w, P, C, T, S, A, _, N, E, R, L, D, j, q, I, M, H, O = "sizzle" + 1 * new Date, F = e.document, B = 0, W = 0, $ = n(), z = n(), U = n(), X = function (e, t) {
                        return e === t && (E = !0),
                            0
                    }, Y = 1 << 31, G = {}.hasOwnProperty, V = [], K = V.pop, J = V.push, Q = V.push, Z = V.slice, ee = function (e, t) {
                        for (var n = 0, i = e.length; i > n; n++)
                            if (e[n] === t)
                                return n;
                        return -1
                    }, te = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", re = "\\[" + ne + "*(" + ie + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ie + "))|)" + ne + "*\\]", oe = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + re + ")*)|.*)\\)|)", se = new RegExp(ne + "+", "g"), ae = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"), ce = new RegExp("^" + ne + "*," + ne + "*"), le = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), ue = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), de = new RegExp(oe), pe = new RegExp("^" + ie + "$"), fe = {
                        ID: new RegExp("^#(" + ie + ")"),
                        CLASS: new RegExp("^\\.(" + ie + ")"),
                        TAG: new RegExp("^(" + ie + "|[*])"),
                        ATTR: new RegExp("^" + re),
                    ...
                    }, he = /^(?:input|select|textarea|button)$/i, ve = /^h\d$/i, ge = /^[^{]+\{\s*\[native \w/, me = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, xe = /'|\\/g, be = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), ke = function (e, t, n) {
                        var i = "0x" + t - 65536;
                    ...
                    k = t.support = {},
                        ...
                        R = t.setDocument = function (e) {
                            ...
                            return i !== L && 9 === i.nodeType && i.documentElement ? (L = i,
                                ...
                                I = [],
                                q = [],
                                (k.qsa = ge.test(L.querySelectorAll)) && (r(function (e) {
                                ...
                                H = t || ge.test(D.contains) ? function (e, t) {
                                ...
                                X = t ? function (e, t) {
                                    ...
                                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                        1 & n || !k.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === F && H(F, e) ? -1 : t === L || t.ownerDocument === F && H(F, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
                                }
                                    : function (e, t) {
                                        if (e === t)
                                            return E = !0,
                        ...
                        t.matchesSelector = function (e, n) {
                            if ((e.ownerDocument || e) !== L && R(e),
                                n = n.replace(ue, "='$1']"),
                                k.matchesSelector && j && !U[n + " "] && (!I || !I.test(n)) && (!q || !q.test(n)))
                                try {
                                    var i = M.call(e, n);
                        ...
                        t.contains = function (e, t) {
                            return (e.ownerDocument || e) !== L && R(e),
                                H(e, t)
                        }
                        ,
                        t.attr = function (e, t) {
                            ...
                            filter: {
                                ...
                                CHILD: function (e, t, n, i, r) {
                                    ...
                                    return 1 === i && 0 === r ? function (e) {
                                        ...
                                        : function (t, n, c) {
                                            var l, u, d, p, f, h, v = o !== s ? "nextSibling" : "previousSibling", g = t.parentNode, m = a && t.nodeName.toLowerCase(), y = !c && !a, x = !1;
                                            if (g) {
                                                if (o) {
                                                    for (; v;) {
                                                        for (p = t; p = p[v];)
                                                ...
                                                if (h = [s ? g.firstChild : g.lastChild],
                                                    ...
                                                    for (p = g,
                                                        ...
                                                        f = l[0] === B && l[1],
                                                        x = f && l[2],
                                                        p = f && g.childNodes[f]; p = ++f && p && p[v] || (x = f = 0) || h.pop();)
                                                    ...
                                                    x = f),
                                                    x === !1)
                                                    for (; (p = ++f && p && p[v] || (x = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (d = p[O] || (p[O] = {}),
                                                        u = d[p.uniqueID] || (d[p.uniqueID] = {}),
                                                        u[e] = [B, x]),
                                                        p !== t));)
                                                        ;
                    ...
                    return d.prototype = w.filters = w.pseudos,
                            ...
                            for (a = e,
                                ...
                                i && !(r = ce.exec(a)) || (r && (a = a.slice(r[0].length) || a),
                                    ...
                                    (r = le.exec(a)) && (i = r.shift(),
                                        ...
                                        a = a.slice(i.length));
                                for (s in w.filter)
                                    !(r = fe[s].exec(a)) || l[s] && !(r = l[s](r)) || (i = r.shift(),
                                        o.push({
                                            value: i,
                                            type: s,
                                            matches: r
                        ...
                        A = t.select = function (e, t, n, i) {
                            var r, o, s, a, c, l = "function" == typeof e && e, d = !i && T(e = l.selector || e);
                            if (n = n || [],
                                1 === d.length) {
                                if (o = d[0] = d[0].slice(0),
                                    o.length > 2 && "ID" === (s = o[0]).type && k.getById && 9 === t.nodeType && j && w.relative[o[1].type]) {
                                    if (t = (w.find.ID(s.matches[0].replace(be, ke), t) || [])[0],
                                        !t)
                                        return n;
                                    l && (t = t.parentNode),
                            ...
                            return (l || S(e, d))(i, t, !j, n, !t || ye.test(e) && u(t.parentNode) || t),
                                n
                        }
                        ,
                        k.sortStable = O.split("").sort(X).join("") === O,
            ...
            var be, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, we = le.fn.init = function (e, t, n) {
                var i, r;
                if (!e)
                    return this;
                if (n = n || be,
            ...
            le.Callbacks = function (e) {
                ...
                var t, n, i, r, o = [], s = [], a = -1, c = function () {
                    for (r = e.once,
                        i = t = !0; s.length; a = -1)
                ...
                le.extend({
                    ...
                    when: function (e) {
                        var t, n, i, r = 0, o = ee.call(arguments), s = o.length, a = 1 !== s || e && le.isFunction(e.promise) ? s : 0, c = 1 === a ? e : le.Deferred(), l = function (e, n, i) {
                            return function (r) {
                                n[e] = this,
                        ...
                        if (s > 1)
                            for (t = new Array(s),
                                n = new Array(s),
                                i = new Array(s); s > r; r++)
                                o[r] && le.isFunction(o[r].promise) ? o[r].promise().progress(l(r, n, t)).done(l(r, i, o)).fail(c.reject) : --a;
                ...
                le.fn.extend({
                    data: function (e, t) {
                        ...
                        return "object" == typeof e ? this.each(function () {
                            ...
                            var n, i;
                            if (o && void 0 === t) {
                                if (n = Ee.get(o, e) || Ee.get(o, e.replace(Le, "-$&").toLowerCase()),
                                    void 0 !== n)
                                    return n;
                                if (i = le.camelCase(e),
                                    n = Ee.get(o, i),
            ...
            le.event = {
                        ...
                        for (n.handler && (o = n,
                            ...
                            a = ze.exec(t[l]) || [],
                                ...
                                f && (d = le.event.special[f] || {},
                                    ...
                                    (p = c[f]) || (p = c[f] = [],
                                        p.delegateCount = 0,
                                        d.setup && d.setup.call(e, i, h, s) !== !1 || e.addEventListener && e.addEventListener(f, s)),
                    ...
                    if (g && (c = g.events)) {
                        for (t = (t || "").match(Te) || [""],
                            ...
                            if (a = ze.exec(t[l]) || [],
                                ...
                                s && !p.length && (d.teardown && d.teardown.call(e, h, g.handle) !== !1 || le.removeEvent(e, f, g.handle),
                                    delete c[f])
                            } else
                                for (f in c)
                                    le.event.remove(e, f + t[l], n, i, !0);
                        le.isEmptyObject(c) && Ne.remove(e, "handle events")
                    }
                },
                dispatch: function (e) {
                    e = le.event.fix(e);
                    var t, n, i, r, o, s = [], a = ee.call(arguments), c = (Ne.get(this, "events") || {})[e.type] || [], l = le.event.special[e.type] || {};
                    if (a[0] = e,
                        e.delegateTarget = this,
                        !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                        for (s = le.event.handlers.call(this, e, c),
                        ...
                        for (; c !== this; c = c.parentNode || this)
                            if (1 === c.nodeType && (c.disabled !== !0 || "click" !== e.type)) {
                                for (i = [],
                                    ...
                                    o = t[n],
                                        r = o.selector + " ",
                                        void 0 === i[r] && (i[r] = o.needsContext ? le(r, this).index(c) > -1 : le.find(r, this, null, [c]).length),
                                        i[r] && i.push(o);
                                i.length && s.push({
                                    elem: c,
                                    handlers: i
                ...
                fix: function (e) {
                    ...
                    for (s || (this.fixHooks[r] = s = $e.test(r) ? this.mouseHooks : We.test(r) ? this.keyHooks : {}),
            ...
            le.extend({
                ...
                clone: function (e, t, n) {
                    var i, r, o, s, a = e.cloneNode(!0), c = le.contains(e.ownerDocument, e);
            ...
            var Ke, Je = {
                HTML: "block",
                BODY: "block"
            }, Qe = /^margin/, Ze = new RegExp("^(" + De + ")(?!px)[a-z%]+$", "i"), et = function (e) {
            ...
            le.extend({
                ...
                style: function (e, t, n, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var r, o, s, a = le.camelCase(t), c = e.style;
                        return t = le.cssProps[a] || (le.cssProps[a] = L(a) || a),
                            ...
                            void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t] : (o = typeof n,
                                "string" === o && (r = je.exec(n)) && r[1] && (n = f(e, t, r),
                                    o = "number"),
                                null != n && n === n && ("number" === o && (n += r && r[3] || (le.cssNumber[a] ? "" : "px")),
                                    ae.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"),
                ...
                le.each(["height", "width"], function (e, t) {
                    le.cssHooks[t] = {
                        ...
                        set: function (e, n, i) {
                            var r, o = i && et(e), s = i && j(e, t, i, "border-box" === le.css(e, "boxSizing", !1, o), o);
                            return s && (r = je.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n,
                                n = le.css(e, t)),
                                D(e, n, s)
                        }
                    }
            ...
            le.Animation = le.extend($, {
                ...
                le.fn.extend({
                    ...
                    finish: function (e) {
                        return e !== !1 && (e = e || "fx"),
                            this.each(function () {
                                var t, n = Ne.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = le.timers, s = i ? i.length : 0;
                                for (n.finish = !0,
                                    le.queue(this, e, []),
                        ...
                        select: {
                            get: function (e) {
                                for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r, s = o ? null : [], a = o ? r + 1 : i.length, c = 0 > r ? a : o ? r : 0; a > c; c++)
                                    if (n = i[c],
                                        (n.selected || c === r) && (ae.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !le.nodeName(n.parentNode, "optgroup"))) {
                                        if (t = le(n).val(),
                                            o)
                                            return t;
                                        s.push(t)
            ...
            le.extend(le.event, {
                trigger: function (e, t, i, r) {
                    var o, s, a, c, l, u, d, p = [i || Z], f = se.call(e, "type") ? e.type : e, h = se.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (s = a = i = i || Z,
                        3 !== i.nodeType && 8 !== i.nodeType && !xt.test(f + le.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."),
                            f = h.shift(),
                            h.sort()),
                            l = f.indexOf(":") < 0 && "on" + f,
                        ...
                        if (!r && !d.noBubble && !le.isWindow(i)) {
                            for (c = d.delegateType || f,
                                xt.test(c + f) || (s = s.parentNode); s; s = s.parentNode)
                                p.push(s),
                                    a = s;
                        ...
                        for (o = 0; (s = p[o++]) && !e.isPropagationStopped();)
                            e.type = o > 1 ? c : d.bindType || f,
                                u = (Ne.get(s, "events") || {})[e.type] && Ne.get(s, "handle"),
                                u && u.apply(s, t),
                                u = l && s[l],
                                u && u.apply && _e(s) && (e.result = u.apply(s, t),
                                    e.result === !1 && e.preventDefault());
                        return e.type = f,
                            r || e.isDefaultPrevented() || d._default && d._default.apply(p.pop(), t) !== !1 || !_e(i) || l && le.isFunction(i[f]) && !le.isWindow(i) && (a = i[l],
                                a && (i[l] = null),
                    ...
                    ajax: function (e, t) {
                        function i(e, t, i, a) {
                            ...
                            2 !== b && (b = 2,
                                ...
                                i && (x = G(p, w, i)),
                                x = V(p, x, w, l),
                                l ? (p.ifModified && (k = w.getResponseHeader("Last-Modified"),
                                    k && (le.lastModified[o] = k),
                                    k = w.getResponseHeader("etag"),
                                    k && (le.etag[o] = k)),
                                    204 === e || "HEAD" === p.type ? P = "nocontent" : 304 === e ? P = "notmodified" : (P = x.state,
                                        d = x.data,
                                        y = x.error,
                                        l = !y)) : (y = P,
                                            !e && P || (P = "error",
                                ...
                                w.statusCode(m),
                                m = void 0,
                                u && h.trigger(l ? "ajaxSuccess" : "ajaxError", [w, p, l ? d : y]),
                                g.fireWith(f, [w, P]),
                        ...
                        "object" == typeof e && (t = e,
                            e = void 0),
                            t = t || {};
                        var r, o, s, a, c, l, u, d, p = le.ajaxSetup({}, t), f = p.context || p, h = p.context && (f.nodeType || f.jquery) ? le(f) : le.event, v = le.Deferred(), g = le.Callbacks("once memory"), m = p.statusCode || {}, y = {}, x = {}, b = 0, k = "canceled", w = {
                            readyState: 0,
                        ...
                        if (v.promise(w).complete = g.add,
                            w.success = w.done,
                            w.error = w.fail,
                            p.url = ((e || p.url || bt.href) + "").replace(Pt, "").replace(_t, bt.protocol + "//"),
                            p.type = t.method || t.type || p.method || p.type,
                            p.dataTypes = le.trim(p.dataType || "*").toLowerCase().match(Te) || [""],
                            null == p.crossDomain) {
                            l = Z.createElement("a");
                            try {
                                l.href = p.url,
                                    l.href = l.href,
                                    p.crossDomain = Lt.protocol + "//" + Lt.host != l.protocol + "//" + l.host
                            } catch (P) {
                                p.crossDomain = !0
                            }
                        }
                        ...
                        u = le.event && p.global,
                            ...
                            p.hasContent || (p.data && (o = p.url += (wt.test(o) ? "&" : "?") + p.data,
                                delete p.data),
                                p.cache === !1 && (p.url = Ct.test(o) ? o.replace(Ct, "$1_=" + kt++) : o + (wt.test(o) ? "&" : "?") + "_=" + kt++)),
                            p.ifModified && (le.lastModified[o] && w.setRequestHeader("If-Modified-Since", le.lastModified[o]),
                        ...
                        if (p.beforeSend && (p.beforeSend.call(f, w, p) === !1 || 2 === b))
                            return w.abort();
                        k = "abort";
                        for (d in {
                            success: 1,
                            ...
                            t = function (e) {
                                return function () {
                                    t && (t = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null,
                                        "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Ht[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                            binary: a.response
                                        } : {
                                                text: a.responseText
            ...
            le.ajaxSetup({
                ...
                le.ajaxPrefilter("json jsonp", function (e, t, i) {
                    ...
                    return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = le.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                        a ? e[a] = e[a].replace(Bt, "$1" + r) : e.jsonp !== !1 && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
            ...
            le.fn.load = function (e, t, n) {
                ...
                le.offset = {
                    setOffset: function (e, t, n) {
                        var i, r, o, s, a, c, l, u = le.css(e, "position"), d = le(e), p = {};
        ...
        (function (t) {
            ...
            u.prototype = {
                draw: function () {
                    ...
                    e.ctx.beginPath(),
                        ...
                        e.ctx.fillRect(this.position[0], this.position[1] + 4, e.width, e.height),
                        e.ctx.fillStyle = "black",
                        e.ctx.rect(this.position[0], this.position[1] + 4, e.width, e.height),
                        e.ctx.lineWidth = "2",
                        e.ctx.font = "14px Arial",
                        e.ctx.textAlign = "center",
                        e.ctx.fillText(e.id, this.position[0] + e.width / 2, this.position[1] + e.textPositions[e.textPosition]),
                        e.ctx.stroke()
                },
            ...
            var d = function () {
                this.canvas = t(".animation canvas")[0],
                    ...
                    this.isRender = !1,
                    this.speedDefault = .7,
                    this.speedPacket = this.speedDefault = .7,
                    this.speedPacketStep = .1,
                    this.delta = 4,
                    this.maxSpeed = 1,
                    this.minSpeed = .1,
                    this.isPaused = !1,
            ...
            d.prototype = {
                ...
                stopTimer: function () {
                    this.waitTimerId && (clearInterval(this.waitTimerId),
                        this.waitTimerId = void 0)
                },
                redrawBoard: function () {
                    ...
                    this.ctx.rect(26 + t.currentPositionInArray * t.widthStep, t.top, t.width, t.height),
                        this.ctx.stroke()
                },
                initBoard: function () {
                    var e = this;
                ...
                killSelectedPacket: function () {
                    ...
                    c && ("send" == c.cell.status ? (i.voice.speak("Packet " + c.cell.id + "is lost."),
                        this.addLog("- Packet " + c.cell.id + " lost")) : (i.voice.speak("Cumulative Ack of Packet " + c.cell.id + "is lost."),
                            this.addLog("- Cumulative Ack of Packet " + c.cell.id + " lost")),
                ...
                sendOnePacket: function (e, t, n, i, r) {
                    ...
                    var s = e
                        ...
                        , c = ""
                        , d = "down";
                    "sender" == n ? ("" == this.allCells.sender[o.id].status && (this.nextSeqNum++,
                        this.updateElements()),
                        c = "receive",
                        d = "down") : (c = "sender",
                            d = "up");
                ...
                sendPacket: function () {
                    ...
                    if (this.waitTimerId ? (i.voice.speak(this.getResultMessage(r.timer_already_running.voice, [r.at_the_sender_side])),
                        i.addLog(this.getResultMessage(r.timer_already_running.text, [r.S]))) : (i.voice.speak(this.getResultMessage(r.start_timer_for_packet.voice, [e.currentCountSenderPackets + e.currentPositionInArray, r.at_the_sender_side])),
                            i.addLog(this.getResultMessage(r.start_timer_for_packet.text, [r.S, e.currentCountSenderPackets + e.currentPositionInArray]))),
                        e.currentCountSenderPackets < 5) {
                        this.sendOnePacket(e.currentCountSenderPackets + e.currentPositionInArray, e.currentCountSenderPackets + e.currentPositionInArray, "sender", "send"),
                            this.allCells.sender[e.currentCountSenderPackets + e.currentPositionInArray].setStatus("waiting");
                        e.currentCountSenderPackets + e.currentPositionInArray;
                        i.voice.speak(this.getResultMessage(r.packet_sent.voice, [e.currentCountSenderPackets + e.currentPositionInArray, r.at_the_sender_side])),
                            i.addLog(this.getResultMessage(r.packet_sent.text, [r.S, e.currentCountSenderPackets + e.currentPositionInArray])),
                ...
                packetReceived: function (e, t) {
                    var n = e.cell;
                    return n.id != t.receivePackets.currentPositionInArray && t.receivePackets.currentPositionInArray > 0 ? (t.sendOnePacket(e.cellWhere.id, t.receivePackets.lastPacketId, "receive", "ack", this.isSelected),
                        t.voice.speak(this.getResultMessage(r.packet_received_out_of_order.voice, [n.id, r.at_the_sender_side, n.id, t.receivePackets.lastPacketId, r.at_the_receiver_side])),
                        void t.addLog(this.getResultMessage(r.packet_received_out_of_order.text, [r.R, n.id, n.id, t.receivePackets.lastPacketId]))) : (n.id > t.receivePackets.currentPositionInArray && (t.voice.speak(this.getResultMessage(r.packet_no_packets_acknowledged.voice, [n.id, r.at_the_receiver_side])),
                            t.addLog(this.getResultMessage(r.packet_no_packets_acknowledged.text, [r.R, n.id]))),
                            void (n.id == t.receivePackets.currentPositionInArray || n.id < t.receivePackets.currentPositionInArray ? (t.allCells.receive[n.id].setStatus("received"),
                                e.cellWhere.setStatus("received"),
                                n.id == t.receivePackets.currentPositionInArray && (t.sendOnePacket(e.cellWhere.id, e.cell.applet.receivePackets.currentPositionInArray, "receive", "ack", e.isSelected),
                                    t.voice.speak(this.getResultMessage(r.packet_received.voice, [e.cell.id, e.cell.id, e.cell.id, r.at_the_receiver_side])),
                                    t.addLog(this.getResultMessage(r.packet_received.text, [r.R, e.cell.id, e.cell.id, e.cell.id]))),
                                n.id < t.receivePackets.currentPositionInArray && t.sendOnePacket(e.cellWhere.id, e.cell.id, "receive", "ack", e.isSelected),
                                this.receivePackets.currentPositionInArray < this.countCells - this.receivePackets.maxCountSenderPacket && t.receivePackets.currentPositionInArray++,
                                t.receivePackets.lastPacketId = n.id) : n.id < t.receivePackets.currentPositionInArray && (t.allCells.receive[n.id].setStatus("received"),
                                    e.cellWhere.setStatus("received"),
                                    t.sendOnePacket(e.cellWhere.id, e.cell.id, "receive", "ack", e.isSelected),
                ...
                ackPacketReceived: function (e, t) {
                    ...
                    if (t.senderPackets.currentPositionInArray < this.countCells - t.senderPackets.maxCountSenderPacket)
                        if (t.senderPackets.currentPositionInArray == n.id)
                            t.allCells.sender[n.id].setStatus("ackReceived"),
                                ...
                                t.voice.speak(this.getResultMessage(r.cumulative_ack_received.voice, [e.cell.id, r.at_the_sender_side])),
                                t.addLog(this.getResultMessage(r.cumulative_ack_received.text, [r.S, e.cell.id]));
                        else if (t.senderPackets.currentPositionInArray <= n.id) {
                            for (var i = t.senderPackets.currentPositionInArray; i <= n.id; i++)
                            ...
                            t.senderPackets.currentPositionInArray > n.id && (t.voice.speak(this.getResultMessage(r.rececive_again_dupack.voice, [e.cell.id, r.at_the_sender_side])),
                                t.addLog(this.getResultMessage(r.rececive_again_dupack.text, [r.S, n.id])));
                    else if (t.senderPackets.currentPositionInArray <= n.id) {
                        "ackReceived" == t.allCells.sender[n.id].status ? (t.voice.speak(this.getResultMessage(r.rececive_again_dupack.voice, [e.cell.id, r.at_the_sender_side])),
                            t.addLog(this.getResultMessage(r.rececive_again_dupack.text, [r.S, n.id]))) : (t.voice.speak(this.getResultMessage(r.cumulative_ack_received.voice, [e.cell.id, r.at_the_sender_side])),
                                t.addLog(this.getResultMessage(r.cumulative_ack_received.text, [r.S, e.cell.id])));
                        for (var i = t.senderPackets.currentPositionInArray; i <= n.id; i++)
                            t.allCells.sender[i].setStatus("ackReceived"),
                                t.senderPackets.lastPacketId = i
                    ...
                    t.allCells.sender.forEach(function (e) {
                        ...
                        t.voice.speak(this.getResultMessage(r.stop_timer.voice, [r.at_the_sender_side])),
                        t.addLog(this.getResultMessage(r.stop_timer.text, [r.S])),
                        o && (t.voice.speak(this.getResultMessage(r.start_timer_for_packet.voice, [1 + n.id, r.at_the_sender_side])),
                            t.addLog(this.getResultMessage(r.start_timer_for_packet.text, [r.S, n.id + 1]))),
                        0 == o && t.stopTimer(),
                        this.updateElements(),
                        this.updateButtons()
                },
                ...
                waitTimer: function () {
                    ...
                    this.allCells.sender.forEach(function (a) {
                        ...
                        "waiting" == c && (n++,
                            ...
                            s = a.id,
                            t && (t = !1,
                                i.voice.speak(i.getResultMessage(r.timeout_occured.voice, [a.id, r.at_the_sender_side])),
                                i.addLog(i.getResultMessage(r.timeout_occured.text, [r.S, a.id]))))
                    }),
                        l = 0,
                        n > 0 && (i.voice.speak(this.getResultMessage(r.all_outstanding_packets.voice, [o, s, o])),
                            i.addLog(this.getResultMessage(r.all_outstanding_packets.text, [o, s, o])))
                },
                pause: function () {
                    this.isPaused = !this.isPaused;
                    this.buttons.pause;
                    this.isPaused ? (i.voice.speak(r.simulation_paused.voice),
                        i.addLog(r.simulation_paused.text),
                        this.lastSpeedPacket = this.speedPacket,
                        this.speedPacket = 0,
                        this.stopTimer(),
                        this.generateTextForAnimation()) : (i.voice.speak(r.simulation_resumed.voice),
                ...
                generateTextForAnimation: function (e) {
                    ...
                    a.forEach(function (e, t) {
                        "ack" == e.cell.status && (n += "Cumulative Ack for Packet " + e.cell.id + " is sent. Click key Num" + (t + 1) + " to kill this ack. "),
                            "send" == e.cell.status && (r += "Packet " + e.cell.id + " is sent. Click key Num" + (t + 1) + " to kill it. ")
                    }),
                        t += n + r,
                        i.addLog(t),
                        i.voice.speak(t)
                ...
                speedUp: function () {
                    ...
                    i.voice.speak(r.simulation_spd_incr.voice),
                        ...
                        this.speedPacket = Math.min(this.maxSpeed * this.delta, this.speedPacket += this.speedPacketStep * this.delta),
                        this.stopTimer(),
                        this.startTimer()
                },
                speedDown: function () {
                    ...
                    i.voice.speak(r.simulation_spd_decr.voice),
                        ...
                        this.speedPacket = Math.max(Math.max(.1, this.minSpeed / this.delta), this.speedPacket -= this.speedPacketStep * this.delta),
                        this.stopTimer(),
                        this.startTimer()
                },
                initButtons: function () {
                    var e = this
                        , n = t(".applet .buttons");
                    t(".bottom-label").css("margin-top", e.canvas.clientHeight - 170 + "px"),
                ...
                updateButtons: function () {
                    this.isPaused ? (this.buttons.send.prop("disabled", !0),
                        this.buttons.faster.prop("disabled", !0),
                        this.buttons.slower.prop("disabled", !0),
                        this.buttons.killPacket.prop("disabled", !0),
                        this.buttons.pause.text("恢复")) : (this.buttons.send.prop("disabled", !1),
                            this.buttons.faster.prop("disabled", !1),
                            this.buttons.slower.prop("disabled", !1),
                            this.buttons.killPacket.prop("disabled", !1),
                            this.buttons.pause.text("暂停")),
                        this.senderPackets.currentCountSenderPackets == this.senderPackets.maxCountSenderPacket && this.buttons.send.prop("disabled", !0);
                    var e = !1;
                ...
                updateElements: function () {
                    this.elements.nextseqnum.text("nextseqnum = " + i.nextSeqNum),
                        this.elements.base.text("base = " + this.senderPackets.currentPositionInArray)
                },
                onKeyPressed: function (e) {
                    ...
                    if (i.isPaused) {
                        ...
                        if (n >= 0) {
                            ...
                            "send" == o.cell.status ? (i.voice.speak(i.getResultMessage(r.packet_lost.voice, [o.cell.id])),
                                i.addLog(i.getResultMessage(r.packet_lost.text, [o.cell.id]))) : (i.voice.speak(i.getResultMessage(r.cumulative_ack_lost.voice, [o.cell.id])),
                                    i.addLog(i.getResultMessage(r.cumulative_ack_lost.text, [o.cell.id]))),
            ...
            var p = function (e) {
                ...
                this.idTimer = -1,
                    ...
                    "down" == n ? this.idTimer = setInterval(this.movingDown.bind(this), 16) : this.idTimer = setInterval(this.movingUp.bind(this), 16),
                    a.push(this)
            };
            p.prototype = {
                receiveAndDestroyPacket: function () {
                    var e = this.cell.applet;
                    switch (clearInterval(this.idTimer),
                    a.remove(this),
                    this.cell.status) {
                        case "send":
                ...
                movingDown: function () {
                    this.cell.position[1] += this.speed(),
                        "sender" == this.cell.type && this.destroyPosition < this.cell.position[1] && this.receiveAndDestroyPacket()
                },
                select: function () {
                    a.forEach(function (e) {
                        e.isSelected = !1
                        ...
                        c = this,
                        c.isSelected = !0,
                        "send" == c.cell.status ? (i.voice.speak(i.getResultMessage(r.packet_selected.voice, [c.cell.id])),
                            i.addLog(i.getResultMessage(r.packet_selected.text, [c.cell.id]))) : (i.voice.speak(i.getResultMessage(r.cumulative_packet_selected.voice, [c.cell.id])),
                                i.addLog(i.getResultMessage(r.cumulative_packet_selected.text, [c.cell.id])))
                },
                movingUp: function () {
                    this.cell.position[1] -= this.speed(),
                        "receive" == this.cell.type && this.destroyPosition > this.cell.position[1] && this.receiveAndDestroyPacket()
                }
            },
    ...
    <div id="content" class="content">
        <h1>回退N步协议</h1>
        <p>
            这个交互式动画使回退N步协议变得栩栩如生。
            在这个演示中，发送窗口将发送方限制为最多有5个未送达、未确认的数据包。
            要创建新数据包，请单击“发送新的”。
            此操作将开始在发送方和接收方之间移动数据包。
            要模拟丢失，请选择一个移动的数据包或ACK，然后按“杀死包/ACK”。
            使用“暂停”和“恢复”使选择更容易。
            通过单击“更快”或“更慢”来加速或减慢模拟。
            <strong>耐心等待</strong>重新传输（即超时）。
        </p>
        <div>
            <div class="applet">
                <div class="buttons" id="buttons-navigation">
                    <button class="send-new">发送新的</button>
                    <button class="pause">暂停</button>
                    <button class="faster">更快</button>
                    <button class="slower">更慢</button>
                    <button class="killpacket-ack">杀死数据包/ACK</button>
                    <button class="reset">重置</button>
                </div>
                <div class="animation">
                    <canvas width="450" height="340"></canvas>
                    <div class="top-label">
                        <p class="blue">发送方（发送窗口大小 = 5）</p>
                        <p class="base">base = 1</p>
                        <p class="nextseqnum">nextseqnum = 5</p>
                        <p class="blue bottom-label" style="margin-top:200px;">接收方（发送窗口大小 = 1）</p>
                    </div>
                </div>
            </div>
            <div class="footer">
                ...
                <div class="log-container" tabindex="-1">
                    <p>(S) - 发送方的操作</p>
                    <p>(R) - 接收方的操作</p>
                    <textarea tabindex="-1" id="log-textarea" rows="20" readonly></textarea>
                </div>
            </div>
        </div>
    </div>`
