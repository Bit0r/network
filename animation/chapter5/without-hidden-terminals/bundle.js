!function (e) {
    ...
    <div class="content">
        ...
        <h1>802.11 CSMA/CA <strong>无</strong>隐藏终端</h1>
        <p>接入点监听所有移动站点。每个移动站点都能接收其他移动站点的信号。</p>
	 ...
	 */
                function (e) {
                    ...
                    function b(e, n) {
                        var r = n.length > 0
                            ...
                            , s = function (i, s, a, u, l) {
                                var c, f, d, p = 0, h = "0", m = i && [], v = [], y = N, b = i || o && T.find.TAG("*", l), x = W += null == y ? 1 : Math.random() || .1, w = b.length;
                    ...
                    var x, w, T, C, S, k, E, A, N, j, D, q, L, P, H, O, R, M, B, F = "sizzle" + 1 * new Date, I = e.document, W = 0, _ = 0, $ = n(), z = n(), U = n(), V = function (e, t) {
                        return e === t && (D = !0),
                            0
                        ...
                        A = t.select = function (e, t, n, i) {
                            ...
                            if (n = n || [],
                                ...
                                if (o = f[0] = f[0].slice(0),
                                    o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && H && T.relative[o[1].type]) {
                            ...
                            return (l || E(e, f))(i, t, !H, n, !t || ye.test(e) && c(t.parentNode) || t),
                                n
                        }
                        ,
                    ...
                    ajax: function (e, t) {
                        function i(e, t, i, a) {
                            ...
                            2 !== x && (x = 2,
                                ...
                                T.status = e,
                                T.statusText = (t || C) + "",
                                l ? m.resolveWith(p, [f, C, T]) : m.rejectWith(p, [T, C, y]),
                                T.statusCode(v),
                                v = void 0,
                                c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [T, d, l ? f : y]),
                                g.fireWith(p, [T, C]),
                        ...
                        "object" == typeof e && (t = e,
                            e = void 0),
                            t = t || {};
                        var r, o, s, a, u, l, c, f, d = le.ajaxSetup({}, t), p = d.context || d, h = d.context && (p.nodeType || p.jquery) ? le(p) : le.event, m = le.Deferred(), g = le.Callbacks("once memory"), v = d.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                            readyState: 0,
                        ...
                        if (m.promise(T).complete = g.add,
                            T.success = T.done,
                            T.error = T.fail,
                            d.url = ((e || d.url || xt.href) + "").replace(Ct, "").replace(Nt, xt.protocol + "//"),
                        ...
                        c = le.event && d.global,
                            ...
                            T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : d.accepts["*"]);
                        for (f in d.headers)
            ...
            le.ajaxSetup({
                ...
                le.ajaxPrefilter("json jsonp", function (e, t, i) {
                    ...
                    return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = le.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                        a ? e[a] = e[a].replace(Wt, "$1" + r) : e.jsonp !== !1 && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
