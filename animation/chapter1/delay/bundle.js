!function (e) {
		...
		(function (e) {
			function t() {
				this.length = 0,
					...
					this.updateselect(),
					this.packetNode = e(".packet"),
					this.timeNode = e(".time"),
					this.simNode = e(".simulation"),
					this.startButton = e(".startButton button"),
					this.resetButton = e(".resetButton button"),
					this.silenceElement = e(".silenceElement"),
					this.startButtonAria = e(".buttonAria"),
					this.startButton.click(function () {
						this.start()
					}
						.bind(this)),
					this.startButtonAria.click(function () {
						this.start()
					}
						.bind(this)),
			...
			t.prototype.updateselect = function () {
				this.length = 1 * e("#length :selected").val(),
					this.rate = 1 * e("#rates :selected").val(),
					this.size = 1 * e("#size :selected").val()
			}
				,
				t.prototype.start = function () {
					...
					this.packetNode.width(t),
						this.packetNode.css("margin-left", -t),
						this.startButtonAria.attr("aria-label", "Start of the animation, a" + o[r[0]] + "packet moves along a " + s[r[1]] + " link with a " + a[r[2]] + " speed from the Sender to the Receiver. End of the animation, the packet has been delivered in " + n + " milliseconds"),
						this.simNode.attr("aria-label", n + " milliseconds"),
						this.startButtonAria.focus(),
						setTimeout(function () {
						...
						this.timerId = setInterval(function () {
							...
							450 > e && (this.packetNode.css("margin-left", "+=" + 82 * (1e4 / this.length)),
								this.time = (1 * this.time + .01).toFixed(2),
								this.timeNode.text(this.time + "0 ms"))
						}
							.bind(this), 50)
				}
				,
				t.prototype.reset = function () {
					this.time = 0,
						this.timeNode.text("0.000 ms"),
						this.simNode.attr("aria-label", "0.000 milliseconds"),
						clearInterval(this.timerId),
						this.packetNode.width(20),
						this.packetNode.css("margin-left", "-20")
				}
				,
				window.onload = l()
		}
	...
	, function (e, t, n) {
		...
		!function (t, n) {
			...
			function E(e, t, n, r) {
				...
				if (g || f > 1 && "string" == typeof d && !ae.checkClone && Ve.test(d))
				...
				if (f && (i = v(t, e[0].ownerDocument, !1, e, r),
					...
					if (a)
						for (l = s[s.length - 1].ownerDocument,
							...
							c = 0; a > c; c++)
							u = s[c],
								Me.test(u.type || "") && !je.access(u, "globalEval") && le.contains(l, u) && (u.src ? le._evalUrl && le._evalUrl(u.src) : le.globalEval(u.textContent.replace(Ge, "")))
				}
				return e
			}
			function S(e, t, n) {
			...
			function j(e) {
				var t = Z
					, n = Qe[e];
				return n || (n = A(e, t),
					"none" !== n && n || (Je = (Je || le("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
			...
			function F(e, t) {
				for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
					r = e[s],
						r.style && (o[s] = je.get(r, "olddisplay"),
							n = r.style.display,
							t ? (o[s] || "none" !== n || (r.style.display = ""),
								"" === r.style.display && Fe(r) && (o[s] = je.access(r, "olddisplay", j(r.nodeName)))) : (i = Fe(r),
									"none" === n && i || je.set(r, "olddisplay", i ? n : le.css(r, "display"))));
				for (s = 0; a > s; s++)
					r = e[s],
			...
			function W(e, t, n) {
				var r, i, o, s, a, u, l, c, f = this, p = {}, d = e.style, h = e.nodeType && Fe(e), g = je.get(e, "fxshow");
				...
				if (le.isEmptyObject(p))
					"inline" === ("none" === l ? j(e.nodeName) : l) && (d.display = l);
				else {
					g ? "hidden" in g && (h = g.hidden) : g = je.access(e, "fxshow", {}),
						o && (g.hidden = !h),
			...
			function $(e, t, n) {
				var r, i, o = 0, s = $.prefilters.length, a = le.Deferred().always(function () {
					delete u.elem
				}), u = function () {
					if (i)
						return !1;
					for (var t = ut || P(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++)
						l.tweens[s].run(o);
	 ...
	 */
				function (e) {
						...
						if (!r && ((t ? t.ownerDocument || t : I) !== q && L(t),
							...
							if (w.qsa && !U[e + " "] && (!R || !R.test(e))) {
								if (1 !== g)
									...
									for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = M),
										f = N(e),
										o = f.length,
					...
					function x(e, n) {
						var i = n.length > 0
							...
							, s = function (r, s, a, u, l) {
								var c, f, p, d = 0, h = "0", g = r && [], m = [], y = A, x = r || o && T.find.TAG("*", l), b = W += null == y ? 1 : Math.random() || .1, w = x.length;
					...
					var b, w, T, C, k, N, E, S, A, j, D, L, q, H, O, R, F, B, P, M = "sizzle" + 1 * new Date, I = e.document, W = 0, z = 0, $ = n(), _ = n(), U = n(), X = function (e, t) {
						return e === t && (D = !0),
							0
					...
					w = t.support = {},
							...
							return r !== q && 9 === r.nodeType && r.documentElement ? (q = r,
								...
								X = t ? function (e, t) {
									...
									return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
										1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === I && P(I, e) ? -1 : t === q || t.ownerDocument === I && P(I, t) ? 1 : j ? ee(j, e) - ee(j, t) : 0 : 4 & n ? -1 : 1)
								}
									: function (e, t) {
										if (e === t)
											return D = !0,
										...
										if (!i || !o)
											return e === q ? -1 : t === q ? 1 : i ? -1 : o ? 1 : j ? ee(j, e) - ee(j, t) : 0;
										if (i === o)
											return s(e, t);
						...
						t.matchesSelector = function (e, n) {
							if ((e.ownerDocument || e) !== q && L(e),
								n = n.replace(ce, "='$1']"),
								w.matchesSelector && O && !U[n + " "] && (!F || !F.test(n)) && (!R || !R.test(n)))
								try {
									var r = B.call(e, n);
										...
										: function (t, n, u) {
											...
											if (v) {
												...
												if (h = [s ? v.firstChild : v.lastChild],
													...
													x = d),
													x === !1)
													for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[M] || (p[M] = {}),
														c = f[p.uniqueID] || (f[p.uniqueID] = {}),
														c[e] = [W, x]),
														p !== t));)
														;
					...
					return f.prototype = T.filters = T.pseudos,
						...
						S = t.select = function (e, t, n, r) {
							...
							return (l || E(e, f))(r, t, !O, n, !t || ye.test(e) && c(t.parentNode) || t),
								n
						}
						,
				...
				le.each({
					...
					le.fn[e] = function (n, r) {
						...
						return "Until" !== e.slice(-5) && (r = n),
							...
							this.length > 1 && (ke[e] || le.uniqueSort(i),
								Ce.test(e) && i.reverse()),
							this.pushStack(i)
					}
				});
				...
				le.extend({
					queue: function (e, t, n) {
						...
						return e ? (t = (t || "fx") + "queue",
							r = je.get(e, t),
							n && (!r || le.isArray(n) ? r = je.access(e, t, le.makeArray(n)) : r.push(n)),
							r || []) : void 0
					},
			...
			le.event = {
				...
				dispatch: function (e) {
					e = le.event.fix(e);
					var t, n, r, i, o, s = [], a = ee.call(arguments), u = (je.get(this, "events") || {})[e.type] || [], l = le.event.special[e.type] || {};
					if (a[0] = e,
				...
				fix: function (e) {
					...
					for (s || (this.fixHooks[i] = s = $e.test(i) ? this.mouseHooks : ze.test(i) ? this.keyHooks : {}),
					...
					if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
						...
						return t = le.cssProps[a] || (le.cssProps[a] = q(a) || a),
							...
							void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : (o = typeof n,
								"string" === o && (i = Oe.exec(n)) && i[1] && (n = d(e, t, i),
									o = "number"),
			...
			le.Animation = le.extend($, {
				...
				le.fn.extend({
					...
					finish: function (e) {
						return e !== !1 && (e = e || "fx"),
							this.each(function () {
								var t, n = je.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = le.timers, s = r ? r.length : 0;
								for (n.finish = !0,
									le.queue(this, e, []),
			...
			le.fn.extend({
				...
				hasClass: function (e) {
					var t, n, r = 0;
					for (t = " " + e + " "; n = this[r++];)
						if (1 === n.nodeType && (" " + _(n) + " ").replace(vt, " ").indexOf(t) > -1)
							return !0;
					return !1
				}
			});
				...
				ae.focusin || le.each({
					...
					le.event.special[t] = {
						...
						teardown: function () {
							var r = this.ownerDocument || this
								, i = je.access(r, t) - 1;
							i ? je.access(r, t, i) : (r.removeEventListener(e, n, !0),
								je.remove(r, t))
						}
					}
				});
				...
				le.extend({
					...
					ajax: function (e, t) {
						...
						if (g.promise(T).complete = v.add,
							...
							p.dataTypes = le.trim(p.dataType || "*").toLowerCase().match(Ne) || [""],
							null == p.crossDomain) {
							l = Z.createElement("a");
							try {
								l.href = p.url,
						...
						c = le.event && p.global,
							...
							p.hasContent || (p.data && (o = p.url += (Tt.test(o) ? "&" : "?") + p.data,
								delete p.data),
								p.cache === !1 && (p.url = kt.test(o) ? o.replace(kt, "$1_=" + wt++) : o + (Tt.test(o) ? "&" : "?") + "_=" + wt++)),
			...
			le.ajaxSetup({
				...
				le.ajaxPrefilter("json jsonp", function (e, t, r) {
					...
					return a || "jsonp" === e.dataTypes[0] ? (i = e.jsonpCallback = le.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
						a ? e[a] = e[a].replace(Wt, "$1" + i) : e.jsonp !== !1 && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
	...
	<div class="content">
		...
		<h1>传输与传播时延</h1>
		<p>
			这个简单的交互式动画演示了计算机网络中最基本的概念之一：传输延迟与传播时延。虽然第一章详细讨论了这个概念，但“交互式动画胜千言”。您可以设置链接的长度、数据包的大小和传输速度；交互式动画将显示数据包从发送方发送到接收方。
		</p>
		<p>注意，对于许多组合，包的头部在发送方完成传输之前到达接收方。</p>
		<div class="container">
			<div class="silenceElement" tabindex="-1"></div>
			<div class="comboboxLabel">长度</div>
			<div class="combobox">
				<select id="length">
					<option value="10E3">10 km</option>
					<option value="100E3">100 km</option>
					<option value="1E6">1000 km</option>
				</select>
			</div>
			<div class="comboboxLabel">比率</div>
			<div class="combobox"> <select id="rates">
					<option value="512E3">512 kps</option>
					<option value="1E6">1 Mbps</option>
					<option value="10E6">10 Mbps</option>
					<option value="100E6">100 Mbps</option>
				</select> </div>
			<div class="comboboxLabel">包大小</div>
			<div class="combobox">
				<select id="size">
			...
			<div class="startButton">
				<button>开始</button>
				<div class="buttonAria focusable" tabindex="-1"></div>
			</div>
			<div class="resetButton">
				<button>重置</button>
			</div>
			<br>
			<div class="simulation" tabindex="0">
				<div class="point" id="sender"></div>
				<div class="chanel">
					<div class="packet"></div>
				</div>
				<div class="time">0.000 ms</div>
				<div class="point" id="receiver"></div>
				<div>
					<div class="senderText">发送方</div>
					<div class="receiverText">接收方</div>
				</div>
				<div class="propagationSpeed">
					<p tabindex="0">
						传播速度：2.8 x 10<sup>8</sup> m/sec
					</p>
				</div>
			</div>
		</div>
